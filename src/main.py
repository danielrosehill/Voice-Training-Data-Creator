...
class VoiceTrainingApp:
            ...
            content=ft.Container(
                content=ft.Column(
                    [
                        ...
                        self.dict_input,
                        ft.Row([self.generate_btn, self.regenerate_btn, self.view_text_btn], spacing=10),
                        ft.Divider(),
                        self.text_edit,
            ...
            content=ft.Container(
                content=ft.Column(
                    [
                        ...
                        self.status_label,
                        self.duration_label,
                        ft.Row([self.record_btn, self.pause_btn, self.stop_btn], spacing=10),
                        self.delete_btn,
                    ],
                    spacing=15,
                ),
    ...
    def build_dataset_tab(self):
        ...
        content = ft.Column(
            [
                ...
                ft.Row([self.dataset_count_label, self.dataset_minutes_label, refresh_btn], spacing=20),
                ft.Divider(),
    ...
    def on_text_changed(self, e):
        ...
        self.view_text_btn.disabled = not bool(text.strip())
        self.page.update()
    ...
    def save_sample(self, e):
        ...
        try:
            ...
            self.status_label.value = "Sample saved"
            self.refresh_statistics()
            self.page.update()

            # Auto-generate next text if enabled
    ...
    def toggle_theme(self):
        ...
        # Start timer thread to update duration label
